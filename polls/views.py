    ...
    if request.user.has_perm('polls.add_poll'):
        if request.method == 'POST':
            ...
            if form.is_valid:
                ...
                messages.success(
                    request, "Опрос и выбор добавлены успешно", extra_tags='alert alert-success alert-dismissible fade show')
        ...
        return HttpResponse("Извините, но у вас нет разрешения на это!")
...
def add_choice(request, poll_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid:
            ...
            new_choice.save()
            messages.success(
                request, "Выбор добавлен успешно", extra_tags='alert alert-success alert-dismissible fade show')
...
def choice_edit(request, choice_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid:
            ...
            new_choice.save()
            messages.success(
                request, "Выбор успешно обновлен", extra_tags='alert alert-success alert-dismissible fade show')
            return redirect('polls:edit', poll.id)
    else:
...
def poll_vote(request, poll_id):
    ...
    if not poll.user_can_vote(request.user):
        messages.error(
            request, "Вы уже проголосовали в данном опросе!", extra_tags='alert alert-warning alert-dismissible fade show')
        return redirect("polls:list")
    ...
    if choice_id:
        ...
        messages.error(
            request, "Вы не выбрали выбор!", extra_tags='alert alert-warning alert-dismissible fade show')
